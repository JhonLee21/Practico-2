...
public class VistaRuleta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Cantidad de Nodos");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int cant = 0;
        cant = this.objListaC.cantidadNodos();
        JOptionPane.showMessageDialog(this, "La cantidad de nodos de la Lista Circular son: "+cant);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaRuleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaRuleta().setVisible(true);
            }
        });
    }
